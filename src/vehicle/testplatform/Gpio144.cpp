...
{
    ERROR_LOGGER.logError("Tried to use Gpio144::makeInput");
...
{
    ERROR_LOGGER.logError("Tried to use Gpio144::makeOutput");
...
{
    ERROR_LOGGER.logError("Tried to use Gpio144::readState");
